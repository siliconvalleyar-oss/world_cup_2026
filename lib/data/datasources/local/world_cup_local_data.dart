...
class WorldCupLocalData {
  ...
  static final Map<String, Map<String, Map<String, int>>> _standingsData = {
    ...
    'E': {
      ...
      '134507': {'p': 2, 'w': 1, 'd': 0, 'l': 1, 'gf': 3, 'ga': 4, 'pts': 3},
      '136477': {'p': 2, 'w': 0, 'd': 0, 'l': 2, 'gf': 1, 'ga': 10, 'pts': 0},
    },
    'F': {
    ...
    'G': {
      ...
      '134515': {'p': 2, 'w': 1, 'd': 1, 'l': 0, 'gf': 3, 'ga': 1, 'pts': 4},
      '134511': {'p': 2, 'w': 0, 'd': 1, 'l': 1, 'gf': 2, 'ga': 4, 'pts': 1},
    ...
    'K': {
      '134501': {'p': 2, 'w': 2, 'd': 0, 'l': 0, 'gf': 4, 'ga': 1, 'pts': 6},
      '133908': {'p': 2, 'w': 1, 'd': 1, 'l': 0, 'gf': 6, 'ga': 1, 'pts': 4},
      '137003': {'p': 2, 'w': 0, 'd': 1, 'l': 1, 'gf': 1, 'ga': 2, 'pts': 1},
      '134537': {'p': 2, 'w': 0, 'd': 0, 'l': 2, 'gf': 1, 'ga': 8, 'pts': 0},
    },
    'L': {
      '133914': {'p': 2, 'w': 1, 'd': 1, 'l': 0, 'gf': 4, 'ga': 2, 'pts': 4},
      '134513': {'p': 2, 'w': 1, 'd': 1, 'l': 0, 'gf': 1, 'ga': 0, 'pts': 4},
      '133912': {'p': 2, 'w': 1, 'd': 0, 'l': 1, 'gf': 3, 'ga': 4, 'pts': 3},
      '134533': {'p': 2, 'w': 0, 'd': 0, 'l': 2, 'gf': 0, 'ga': 2, 'pts': 0},
    },
  };
